...
DATASET_ACCESSION="GCF_000027325.1"                            # RefSeq accession number for the genome
...
URL="https://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/009/771/035/GCA_009771035.1_CNRS_Lalb_1.0/GCA_009771035.1_CNRS_Lalb_1.0_genomic.gff.gz"  # Backup URL for GFF file
